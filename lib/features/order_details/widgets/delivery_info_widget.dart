    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Column(children: [
          ...
          '${orderModel!.shippingAddress?.address}${orderModel!.shippingAddress?.city != null ? ',' : ''}  ''${orderModel!.shippingAddress?.city ?? ''}${orderModel!.shippingAddress?.zip != null ? ',' : ''} ''${orderModel!.shippingAddress?.zip ?? ''}' :  '',
